...
// SubDouyuLiveMutation represents an operation that mutates the SubDouyuLive nodes in the graph.
type SubDouyuLiveMutation struct {
	config
	op                 Op
	typ                string
	id                 *int64
	...
	oldValue           func(context.Context) (*SubDouyuLive, error)
	predicates         []predicate.SubDouyuLive
}

var _ ent.Mutation = (*SubDouyuLiveMutation)(nil)

// subdouyuliveOption allows management of the mutation configuration using functional options.
type subdouyuliveOption func(*SubDouyuLiveMutation)

// newSubDouyuLiveMutation creates new mutation for the SubDouyuLive entity.
func newSubDouyuLiveMutation(c config, op Op, opts ...subdouyuliveOption) *SubDouyuLiveMutation {
	m := &SubDouyuLiveMutation{
		config:        c,
		op:            op,
		typ:           TypeSubDouyuLive,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withSubDouyuLiveID sets the ID field of the mutation.
func withSubDouyuLiveID(id int64) subdouyuliveOption {
	return func(m *SubDouyuLiveMutation) {
		var (
			err   error
			once  sync.Once
			value *SubDouyuLive
		)
		m.oldValue = func(ctx context.Context) (*SubDouyuLive, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SubDouyuLive.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSubDouyuLive sets the old SubDouyuLive of the mutation.
func withSubDouyuLive(node *SubDouyuLive) subdouyuliveOption {
	return func(m *SubDouyuLiveMutation) {
		m.oldValue = func(context.Context) (*SubDouyuLive, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SubDouyuLiveMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SubDouyuLiveMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of SubDouyuLive entities.
func (m *SubDouyuLiveMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SubDouyuLiveMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SubDouyuLiveMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SubDouyuLive.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetRoomID sets the "room_id" field.
func (m *SubDouyuLiveMutation) SetRoomID(i int64) {
	m.room_id = &i
	m.addroom_id = nil
}

// RoomID returns the value of the "room_id" field in the mutation.
func (m *SubDouyuLiveMutation) RoomID() (r int64, exists bool) {
	v := m.room_id
	if v == nil {
		return
	}
...
// OldRoomID returns the old "room_id" field's value of the SubDouyuLive entity.
// If the SubDouyuLive object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubDouyuLiveMutation) OldRoomID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldRoomID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddRoomID adds i to the "room_id" field.
func (m *SubDouyuLiveMutation) AddRoomID(i int64) {
	if m.addroom_id != nil {
		*m.addroom_id += i
	} else {
		m.addroom_id = &i
...
// AddedRoomID returns the value that was added to the "room_id" field in this mutation.
func (m *SubDouyuLiveMutation) AddedRoomID() (r int64, exists bool) {
	v := m.addroom_id
	if v == nil {
		return
	}
...
// ResetRoomID resets all changes to the "room_id" field.
func (m *SubDouyuLiveMutation) ResetRoomID() {
	m.room_id = nil
	m.addroom_id = nil
}

// SetLiveState sets the "live_state" field.
func (m *SubDouyuLiveMutation) SetLiveState(i int64) {
	m.live_state = &i
	m.addlive_state = nil
}

// LiveState returns the value of the "live_state" field in the mutation.
func (m *SubDouyuLiveMutation) LiveState() (r int64, exists bool) {
	v := m.live_state
	if v == nil {
		return
	}
...
// OldLiveState returns the old "live_state" field's value of the SubDouyuLive entity.
// If the SubDouyuLive object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubDouyuLiveMutation) OldLiveState(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLiveState is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddLiveState adds i to the "live_state" field.
func (m *SubDouyuLiveMutation) AddLiveState(i int64) {
	if m.addlive_state != nil {
		*m.addlive_state += i
	} else {
		m.addlive_state = &i
...
// AddedLiveState returns the value that was added to the "live_state" field in this mutation.
func (m *SubDouyuLiveMutation) AddedLiveState() (r int64, exists bool) {
	v := m.addlive_state
	if v == nil {
		return
	}
...
// ResetLiveState resets all changes to the "live_state" field.
func (m *SubDouyuLiveMutation) ResetLiveState() {
	m.live_state = nil
	m.addlive_state = nil
}

// SetLiveStartTime sets the "live_start_time" field.
func (m *SubDouyuLiveMutation) SetLiveStartTime(i int64) {
	m.live_start_time = &i
	m.addlive_start_time = nil
}

// LiveStartTime returns the value of the "live_start_time" field in the mutation.
func (m *SubDouyuLiveMutation) LiveStartTime() (r int64, exists bool) {
	v := m.live_start_time
	if v == nil {
		return
	}
...
// OldLiveStartTime returns the old "live_start_time" field's value of the SubDouyuLive entity.
// If the SubDouyuLive object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubDouyuLiveMutation) OldLiveStartTime(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLiveStartTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddLiveStartTime adds i to the "live_start_time" field.
func (m *SubDouyuLiveMutation) AddLiveStartTime(i int64) {
	if m.addlive_start_time != nil {
		*m.addlive_start_time += i
	} else {
		m.addlive_start_time = &i
...
// AddedLiveStartTime returns the value that was added to the "live_start_time" field in this mutation.
func (m *SubDouyuLiveMutation) AddedLiveStartTime() (r int64, exists bool) {
	v := m.addlive_start_time
	if v == nil {
		return
	}
...
// ResetLiveStartTime resets all changes to the "live_start_time" field.
func (m *SubDouyuLiveMutation) ResetLiveStartTime() {
	m.live_start_time = nil
	m.addlive_start_time = nil
}

// SetLiveEndTime sets the "live_end_time" field.
func (m *SubDouyuLiveMutation) SetLiveEndTime(i int64) {
	m.live_end_time = &i
	m.addlive_end_time = nil
}

// LiveEndTime returns the value of the "live_end_time" field in the mutation.
func (m *SubDouyuLiveMutation) LiveEndTime() (r int64, exists bool) {
	v := m.live_end_time
	if v == nil {
		return
	}
...
// OldLiveEndTime returns the old "live_end_time" field's value of the SubDouyuLive entity.
// If the SubDouyuLive object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubDouyuLiveMutation) OldLiveEndTime(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLiveEndTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddLiveEndTime adds i to the "live_end_time" field.
func (m *SubDouyuLiveMutation) AddLiveEndTime(i int64) {
	if m.addlive_end_time != nil {
		*m.addlive_end_time += i
	} else {
		m.addlive_end_time = &i
...
// AddedLiveEndTime returns the value that was added to the "live_end_time" field in this mutation.
func (m *SubDouyuLiveMutation) AddedLiveEndTime() (r int64, exists bool) {
	v := m.addlive_end_time
	if v == nil {
		return
	}
...
// ResetLiveEndTime resets all changes to the "live_end_time" field.
func (m *SubDouyuLiveMutation) ResetLiveEndTime() {
	m.live_end_time = nil
	m.addlive_end_time = nil
}

// SetCreateTime sets the "create_time" field.
func (m *SubDouyuLiveMutation) SetCreateTime(t time.Time) {
	m.create_time = &t
}

// CreateTime returns the value of the "create_time" field in the mutation.
func (m *SubDouyuLiveMutation) CreateTime() (r time.Time, exists bool) {
	v := m.create_time
	if v == nil {
		return
	}
...
// OldCreateTime returns the old "create_time" field's value of the SubDouyuLive entity.
// If the SubDouyuLive object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubDouyuLiveMutation) OldCreateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCreateTime clears the value of the "create_time" field.
func (m *SubDouyuLiveMutation) ClearCreateTime() {
	m.create_time = nil
	m.clearedFields[subdouyulive.FieldCreateTime] = struct{}{}
}

// CreateTimeCleared returns if the "create_time" field was cleared in this mutation.
func (m *SubDouyuLiveMutation) CreateTimeCleared() bool {
	_, ok := m.clearedFields[subdouyulive.FieldCreateTime]
	return ok
}

// ResetCreateTime resets all changes to the "create_time" field.
func (m *SubDouyuLiveMutation) ResetCreateTime() {
	m.create_time = nil
	delete(m.clearedFields, subdouyulive.FieldCreateTime)
}

// SetUpdateTime sets the "update_time" field.
func (m *SubDouyuLiveMutation) SetUpdateTime(t time.Time) {
	m.update_time = &t
}

// UpdateTime returns the value of the "update_time" field in the mutation.
func (m *SubDouyuLiveMutation) UpdateTime() (r time.Time, exists bool) {
	v := m.update_time
	if v == nil {
		return
	}
...
// OldUpdateTime returns the old "update_time" field's value of the SubDouyuLive entity.
// If the SubDouyuLive object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubDouyuLiveMutation) OldUpdateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearUpdateTime clears the value of the "update_time" field.
func (m *SubDouyuLiveMutation) ClearUpdateTime() {
	m.update_time = nil
	m.clearedFields[subdouyulive.FieldUpdateTime] = struct{}{}
}

// UpdateTimeCleared returns if the "update_time" field was cleared in this mutation.
func (m *SubDouyuLiveMutation) UpdateTimeCleared() bool {
	_, ok := m.clearedFields[subdouyulive.FieldUpdateTime]
	return ok
}

// ResetUpdateTime resets all changes to the "update_time" field.
func (m *SubDouyuLiveMutation) ResetUpdateTime() {
	m.update_time = nil
	delete(m.clearedFields, subdouyulive.FieldUpdateTime)
}

// Where appends a list predicates to the SubDouyuLiveMutation builder.
func (m *SubDouyuLiveMutation) Where(ps ...predicate.SubDouyuLive) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SubDouyuLiveMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SubDouyuLiveMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SubDouyuLive, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SubDouyuLiveMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SubDouyuLiveMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SubDouyuLive).
func (m *SubDouyuLiveMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SubDouyuLiveMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m.room_id != nil {
		fields = append(fields, subdouyulive.FieldRoomID)
	}
	if m.live_state != nil {
		fields = append(fields, subdouyulive.FieldLiveState)
	}
	if m.live_start_time != nil {
		fields = append(fields, subdouyulive.FieldLiveStartTime)
	}
	if m.live_end_time != nil {
		fields = append(fields, subdouyulive.FieldLiveEndTime)
	}
	if m.create_time != nil {
		fields = append(fields, subdouyulive.FieldCreateTime)
	}
	if m.update_time != nil {
		fields = append(fields, subdouyulive.FieldUpdateTime)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SubDouyuLiveMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SubDouyuLiveMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case subdouyulive.FieldRoomID:
		return m.OldRoomID(ctx)
	case subdouyulive.FieldLiveState:
	...
	return nil, fmt.Errorf("unknown SubDouyuLive field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SubDouyuLiveMutation) SetField(name string, value ent.Value) error {
	switch name {
	case subdouyulive.FieldRoomID:
		v, ok := value.(int64)
		if !ok {
	...
	return fmt.Errorf("unknown SubDouyuLive field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SubDouyuLiveMutation) AddedFields() []string {
	var fields []string
	if m.addroom_id != nil {
		fields = append(fields, subdouyulive.FieldRoomID)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SubDouyuLiveMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case subdouyulive.FieldRoomID:
		return m.AddedRoomID()
	case subdouyulive.FieldLiveState:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SubDouyuLiveMutation) AddField(name string, value ent.Value) error {
	switch name {
	case subdouyulive.FieldRoomID:
		v, ok := value.(int64)
		if !ok {
	...
	return fmt.Errorf("unknown SubDouyuLive numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SubDouyuLiveMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(subdouyulive.FieldCreateTime) {
		fields = append(fields, subdouyulive.FieldCreateTime)
	}
	if m.FieldCleared(subdouyulive.FieldUpdateTime) {
		fields = append(fields, subdouyulive.FieldUpdateTime)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SubDouyuLiveMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SubDouyuLiveMutation) ClearField(name string) error {
	switch name {
	case subdouyulive.FieldCreateTime:
		m.ClearCreateTime()
		return nil
	...
	return fmt.Errorf("unknown SubDouyuLive nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SubDouyuLiveMutation) ResetField(name string) error {
	switch name {
	case subdouyulive.FieldRoomID:
		m.ResetRoomID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SubDouyuLiveMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SubDouyuLiveMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SubDouyuLiveMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SubDouyuLiveMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SubDouyuLiveMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SubDouyuLiveMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SubDouyuLiveMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown SubDouyuLive unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SubDouyuLiveMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown SubDouyuLive edge %s", name)
}
