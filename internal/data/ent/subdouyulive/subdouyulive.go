...
const (
	// Label holds the string label denoting the subdouyulive type in the database.
	Label = "sub_douyu_live"
	...
	// Table holds the table name of the subdouyulive in the database.
	Table = "sub_douyu_live"
)

// Columns holds all SQL columns for subdouyulive fields.
var Columns = []string{
	FieldID,
	FieldRoomID,
	FieldLiveState,
...
// OrderOption defines the ordering options for the SubDouyuLive queries.
