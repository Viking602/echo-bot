...
const (
	// Label holds the string label denoting the bililivesetting type in the database.
	Label = "bili_live_setting"
	...
	// Table holds the table name of the bililivesetting in the database.
	Table = "bili_live_setting"
)

// Columns holds all SQL columns for bililivesetting fields.
var Columns = []string{
	FieldID,
	FieldRoomID,
	FieldLiveState,
...
// OrderOption defines the ordering options for the BiliLiveSetting queries.
